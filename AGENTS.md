...
This directory  asistente-asignatura/scriptsAuxiliares/conversores contains various conversion utilities for the teaching assistant project. Each converter is designed as an independent tool with its own Python environment and dependencies.
